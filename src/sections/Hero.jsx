...
import NewShape from '../components/newshape.jsx';
        ...
        <Canvas className="w-full h-full">
          <Suspense fallback={<CanvasLoader />}>
            ...
            <group>
              ...
              <ReactLogo position={[8, 5, 0]} />
              <ReactLogo position={[-sizes.reactLogoPosition[0], sizes.reactLogoPosition[2], sizes.reactLogoPosition[2]]} />
              <Rings position={sizes.ringPosition} />
              <NewShape position={sizes.cubePosition} scale={1} />
            </group>
